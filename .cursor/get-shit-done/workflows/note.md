...
- **Global scope**: `/Users/giovanniabbatepaolo/Documents/GitHub/quizzapp/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/giovanniabbatepaolo/Documents/GitHub/quizzapp/.cursor/notes/`)
...
2. Glob `/Users/giovanniabbatepaolo/Documents/GitHub/quizzapp/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/giovanniabbatepaolo/Documents/GitHub/quizzapp/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/giovanniabbatepaolo/Documents/GitHub/quizzapp/.cursor/notes/` — works in any directory
